...
import Header from "../../styles/assets/headernew.png";
...
export default function Social(){
    ...
    <div className="sidebarparent">
        <section className="sidebar">
            ...
            <img className="sidebar__img" src={Settings} alt="settings icon" />
        </section>
            <form className="sidebar__form">
                <input type="search" className="sidebar__input" placeholder="Search"/>
            </form>
    ...
    <div className="mainparent">
        ...
        <div className="firstfeed">
            ...
            <p className="firstfeed__subheader2">  .  Top Seller  .  February 15 at 10:06 AM</p>
            <div  className="imagetextparent">
                <div className="imageparent">
                 <img className="firstfeed__img" src={Garagesale} alt="craft fair" />
                </div>
                ...
                🌟 When: Saturday, February 28th, 12 pM - 5 PM
                    ...
                    <br/>
                    📞 Contact: Jane Doe - (555) 123-4567 (Text or Call for inquiries)
                    <br/>
                    Join us for a huge garage sale with items from multiple families! Everything must go! Great deals on gently used items, perfect for bargain hunters and treasure seekers alike.</p>
                </div>
            </div>
        ...
        <h2 className="firstfeed__header">Handmade Jewelry Craft Fair</h2>
            ...
            <div  className="imagetextparent">
            <div className="imageparent">
                <img className="firstfeed__img" src={Craftfair} alt="craft fair" />
            </div>
            <div className="textparent">
            <p className="firstfeed__text1" >
            📅 Date: Saturday, March 25th
                <br/>
                📍 Location: Harbor Town Community Center, 123 Seaside Lane, Harbor Town
                <br/>

                Dive into the heart of creativity at the Harbor Town Annual Craft Fair! We're bringing together local artisans, craft enthusiasts, and vibrant talents from across the region for a one-of-a-kind shopping experience. Discover unique, handcrafted goods that tell a story, from stunning jewelry and ceramics to bespoke textiles and artisanal foods.</p>
        </div>
